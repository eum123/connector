...
public class SyncClientDisconnectTest {
	...
	public static void main(String[] args) {
		SyncClientDisconnectTest t = new SyncClientDisconnectTest();
		try {
			t.setUp();
	...
	public void test() throws Exception {
		...
		try {
			client = (SyncClient)DriverManager.getClient("client:sync://127.0.0.1:30001?readSize=10&disconnect=false");
