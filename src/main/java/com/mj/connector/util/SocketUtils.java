package com.tsis.connector.util;
		...
		int findAvailablePort(int minPort, int maxPort) {
			...
			do {
				if (++searchCounter > portRange) {
					throw new IllegalStateException(String.format("Could not find an available %s port in the range [%d, %d] after %d attempts", name(),
